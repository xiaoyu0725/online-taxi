...
function genSlot(node, context) {
    ...
    node.props = node.props.filter((prop) => {
        ...
        else if (((_a = prop.arg) === null || _a === void 0 ? void 0 : _a.type) === 4 /* NodeTypes.SIMPLE_EXPRESSION */) {
    ...
    if (nameProp) {
        if ((0, uni_cli_shared_1.isAttributeNode)(nameProp)) {
            if ((_a = nameProp.value) === null || _a === void 0 ? void 0 : _a.content) {
...
function genTemplate(node, context) {
    const slotProp = node.props.find((prop) => {
        var _a;
        return prop.type === 7 /* NodeTypes.DIRECTIVE */ &&
            (prop.name === 'slot' ||
                (prop.name === 'bind' &&
                    ((_a = prop.arg) === null || _a === void 0 ? void 0 : _a.type) === 4 /* NodeTypes.SIMPLE_EXPRESSION */ &&
...
function genElement(node, context) {
    ...
    if ((0, uni_cli_shared_1.isUserComponent)(node, context)) {
        ...
        if ((_c = context.component) === null || _c === void 0 ? void 0 : _c.mergeVirtualHostAttributes) {
            virtualHost = true;
        }
    }
    const { push } = context;
